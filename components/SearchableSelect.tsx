...
export const SearchableSelect: React.FC<SearchableSelectProps> = ({
  ...
  return (
    <div className={`relative ${className}`} ref={containerRef}>
      ...
      {isOpen && (
        <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-2xl z-50 overflow-hidden flex flex-col">
