import type { LiveMapTrackedAsset, TrackedPosition, XadTag, XadTagCommunicationStatus } from '@ktag/shared';
...
export const trackingApi = {
  registerXadTag: (imei: string, macAddress?: string, description?: string) => request<XadTag>('/api/xadtags', { method: 'POST', body: JSON.stringify({ imei, macAddress, description }) }),
